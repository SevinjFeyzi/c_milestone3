...
void fillPatientsDateInMinutes(struct ClinicData* data, int appointment_count);

void sortByDateAndTime(struct Appointment* appointments, int appointment_count);

int yearToMin(const int year);

int monthToMin(const int month);

int dayToMin(const int day);

int hourToMin(const int hour);

int findFirstEmptyAppointmentindex(struct Appointment* appointments, int maxAppointments);

int NumberOfDays(int year, int month);

void dateToMin(struct Appointment* appointment);
